...
We need to separate th females in the population, and then run the inference against the subset that is only made up of females. From there we can test the effectiveness of the drug triUmpsal among females. 
...
In this write-up we determined and analyzed whether the drug triUmp is effective in preventing aids infection among females. This drug was compared to a placebo, and the frequency and percentage of the infection were tallied. Based on the inferential and descriptive results; it was observed that among females who got aids, majority of those were the ones who got the treatment. In other words, the drug showed to be ineffective against the prevention of aids amng females. 
